...
//MyReachability fully support IPv6.  For full details, see ReadMe.md.


NSString *konstReachabilityChangedNotification = @"kNetworkReachabilityChangedNotification";
...
#pragma unused (target, flags)
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName: konstReachabilityChangedNotification object: noteObject];
}
