//
//  FamilyPerTransactionDataField.m
//  Example
//
...
@implementation FamilyPerTransactionDataField
...
- (instancetype)init
{
    self = [super init];
    if (self) {
        self.navigationTitle = @"Definir limite por transação";
        self.currentLabel    = @"Limite por transação atual";
        self.title           = @"Digite o novo limite";
        
        self.serverKey       = @"transactionPriceLimit";
